...
$backurl="/spasibo/?utm_source=АБК2&utm_medium=конверсия&utm_campaign=заявка";  // На какую страничку переходит после отправки письма
...
mail("$adminemail", "$date $time [Заявка DeLife АБК2] $phone ", "$msg");
