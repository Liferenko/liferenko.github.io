...
$msg="
Перезвоните мне! Я у вас на сайте. Интересует проекционная система.
...
mail("$adminemail", "$date $time [Заявка PJ Image Обратный звонок] $name на $message ", "$msg");
...
fwrite($f," \n $date $time Заявка с формы обратного звонка от $phone");
